...
public class SongsLibrary extends Library implements Isong {
    ...
    public void storeObjects() {
        Song doNotDisturb = new Song("Drake", "Do not Disturb", "Image Drake", "As the final cut on More Life, Do Not Disturb picks up where Lose You left off, showing Drake at his most pensive state.", "Hip hop", "4:43", 1, new Date(117,6,12));
        Song idontCare = new Song("Fall out boys", "I dont Care", "Image Folie à Deux", "I Don't Care From the album ", "Pop Rock", "4:30", 2, new Date(90,3,10));
