...
public class ClasePrincipal {
    ...
    public static void main(String[] args) {
        ...
        playList.newPlayList(principalLibrary.getCollectionSong());
        System.out.println(playList.getCollectionPlaylist());
        */
        Filter filter=new Filter();
        filter.genderFilter(principalLibrary.getCollectionSong());
        filter.yearFilter(principalLibrary.getCollectionSong());
